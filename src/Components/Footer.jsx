...
function Footer() {
  return (<>
    ...
    <div className='d-flex-column justify-content-between  mt-5'>
      ...
      <Link  to={'/history'}style={{textDecoration:'none',color:'white'}}>Watch history</Link><br />
      </div>
    </div>
    ...
    <div className='d-flex-column justify-content-between me-5 mt-5'>
     ...
     <i class="fa-brands fa-facebook" style={{marginLeft:'5px',color:'white'}}></i> 
     <i class="fa-brands fa-twitter" style={{marginLeft:'5px' ,color:'white'}}></i>
     <i class="fa-brands fa-instagram" style={{marginLeft:'5px' ,color:'white'}}></i>
     <i class="fa-brands fa-github" style={{marginLeft:'5px',color:'white'}}></i>
     <i class="fa-brands fa-linkedin" style={{marginLeft:'5px',color:'white'}}></i>
     <i class="fa-regular fa-envelope" style={{marginLeft:'5px',color:'white'}}></i>
     </div>
      </div>
    </div>
